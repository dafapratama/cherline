...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>/css/editprofilestlye.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex" href="<?= base_url('admin') ?>">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="my-auto px-0">
                        <a class="xs-auto fa fa-edit" href="<?= base_url('admin/editprof') ?>"></a>
                    </div>
                </div>
            </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('admin/v_user') ?>" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Data</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/v_user') ?>">User</a>
                        <a class="collapse-item" href="<?= base_url('admin/v_admin') ?>">System Admin</a>
                        <a class="collapse-item" href="<?= base_url('admin/v_sales') ?>">Sales Admin</a>
                        <a class="collapse-item" href="<?= base_url('admin/v_pembeli') ?>">Pembeli</a>
                    </div>
                </div>
            </li>
        </ul>
